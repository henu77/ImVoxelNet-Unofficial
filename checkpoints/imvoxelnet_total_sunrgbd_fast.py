model = dict(
    ...
    head_2d=dict(
        ...
        linear_size=256,
        dropout=.0,
        loss_angle=dict(type='mmdet.SmoothL1Loss', loss_weight=100.),
        loss_layout=dict(type='RotatedIoU3DLoss', loss_weight=1.)),
    neck=dict(
        type='mmdet.FPN',
...
data_root = r'D:/Project/mmdetection3d/data/sunrgbd/'
class_names = [
...
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Resize', scale=[(512, 384), (768, 576)], multiscale_mode='range', keep_ratio=True),
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='sunrgbd_total_infos_val.pkl',
        pipeline=test_pipeline,
        test_mode=True,
        box_type_3d='Depth',
        metainfo=metainfo,
